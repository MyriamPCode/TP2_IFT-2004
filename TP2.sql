...
/*Il n'est pas possible d'ajouter un enregistrement dans Oracle car la vue est automatiquement mise � jour par l'utilisateur � la moindre modification de la table. Il n'y a donc aucun enrgistrement qui ne peut �tre effectu�e.*/
