...
insert into TP2_UTILISATEUR_PROJET (NO_UTILISATEUR, CODE_PROJET) values (1000, 'A1B2');
...
insert into TP2_PROFIL_ACCESSIBILITE_IMAGE_COORDONNEE (NO_IMAGE, NOM_I_COO, DESC_CO, POSITION_X_COO, POSITION_Y_COO) values (842635, 'Porte cachée' , 'Vue porte cachée ouest corridor jardin' , 8, 25);
insert into TP2_PROFIL_ACCESSIBILITE_IMAGE_COORDONNEE (NO_IMAGE, NOM_I_COO, DESC_CO, POSITION_X_COO, POSITION_Y_COO) values (489968, 'La voute de Chtulhu' , 'Vue entrée nord cité R''lyeh avec voute' , 4, 6);

insert into TP2_PROFIL_ACCESSIBILITE_PLAN (NO_PLAN, NO_PROFIL, HAUTEUR_PLA, LARGEUR_PLA) values (1, 143602, 50, 100);
insert into TP2_PROFIL_ACCESSIBILITE_PLAN (NO_PLAN, NO_PROFIL, HAUTEUR_PLA, LARGEUR_PLA) values (2, 999666, 1080, 1920);
...
insert into TP2_REPONSE_UTILISATEUR (NO_UTILISATEUR, ID_CHOIX_REPONSE, TEXTE_REP) values (1000, 589998, 'Yoda');
insert into TP2_REPONSE_UTILISATEUR (NO_UTILISATEUR, ID_CHOIX_REPONSE, TEXTE_REP) values (1000, 589999, 'Obi-Wan Kenobi');
insert into TP2_REPONSE_UTILISATEUR (NO_UTILISATEUR, ID_CHOIX_REPONSE, TEXTE_REP) values (1000, 589997, 'Darth Vader');
